...
<header class="navigation">
	...
	<nav class="navbar navbar-expand-lg  py-4" id="navbar">
		<div class="container">
		<a class="navbar-brand" href="<?php echo base_url();?>Doctor/doctorhome">
		  ...
		  <div class="collapse navbar-collapse text-center" id="navbarsExample09">
			<ul class="navbar-nav ml-auto">
			  <li class="nav-item active">
				<a class="nav-link" href="<?php echo base_url();?>Doctor/doctorhome">Home <span class="sr-only">(current)</span></a>
			  </li> <li class="nav-item active">
			 
				<a class="nav-link" href="<?php echo base_url();?>Doctor/doctorhospitalconsultation">Consultation<span class="sr-only">(current)</span></a>
			  </li>
			  <li class="nav-item active">
			 
				<a class="nav-link" href="<?php echo base_url();?>Doctor/doctorbookview">Appointment<span class="sr-only">(current)</span></a>
			  </li>
			  <!-- <li class="nav-item active">
			 
			 <a class="nav-link" href="<?php echo base_url();?>Doctor/doctorleave">Leave<span class="sr-only">(current)</span></a>
		   </li> -->
		   <!-- <li class="nav-item active">
			 
			 <a class="nav-link" href="<?php echo base_url();?>Doctor/doctorhospital">Leave<span class="sr-only">(current)</span></a>
		   </li> -->
			  ...
			  <li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdown03">
						<li><a class="dropdown-item" href="<?php echo base_url();?>Doctor/doctorhospital">Leave request</a></li>
						<li><a class="dropdown-item" href="<?php echo base_url();?>Doctor/doctorleavereq">My leave request</a></li>
					</ul>
			  </li>
			  ...
			  <li class="nav-item active">
				<a class="nav-link" href="<?php echo base_url();?>Doctor/dchat">Message<span class="sr-only">(current)</span></a>
			  </li> 
			   <li class="nav-item active">
				<a class="nav-link" href="<?php echo base_url();?>Doctor/doctorprofileview">Profile <span class="sr-only">(current)</span></a>
			  </li> 
			  <li class="nav-item active">
			</ul>
		...
		<div class="row">
			<div class="col-lg-9 col-md-10">
				<div class="block">
					...
					<a href="<?php echo base_url();?>Doctor/doctorhome" target="_blank" class="btn btn-main animated fadeInUp btn-round-full" >Get started<i class="btn-icon fa fa-angle-right ml-2"></i></a>
				</div>
			</div>
		</div>
	</div>
