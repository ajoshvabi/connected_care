...
<header class="navigation">
	<div class="header-top ">
		<div class="container">
			<div class="row justify-content-between align-items-center">
				...
				<div class="col-lg-11 col-md-8 text-center text-lg-right text-md-right">
					<div class="header-top-info">
						<!-- <a href="tel:+23-345-67890">Call Us : <span>+23-345-67890</span></a>
						<a href="mailto:support@gmail.com" ><i class="fa fa-envelope mr-2"></i><span>support@gmail.com</span></a> -->
						<a href="<?php echo base_url();?>Hospital/labreg" ><i class="fa fa-envelope mr-2"></i><span>Add lab</span></a>
						<a href="<?php echo base_url();?>Hospital/labview" ><i class="fa fa-envelope mr-2"></i><span>Lab</span></a>
	...
	<nav class="navbar navbar-expand-lg  py-4" id="navbar">
		<div class="container">
		<a class="navbar-brand" href="<?php echo base_url();?>Hospital/hospitalhome">
		  ...
		  <div class="collapse navbar-collapse text-center" id="navbarsExample09">
			<ul class="navbar-nav ml-auto">
			  <li class="nav-item active">
				<a class="nav-link" href="<?php echo base_url();?>Hospital/hospitalhome">Home <span class="sr-only">(current)</span></a>
			  </li>
			  <li class="nav-item active">
				<a class="nav-link" href="<?php echo base_url();?>Hospital/hospitaldoctorview">Doctor details <span class="sr-only">(current)</span></a>
			  </li>
			  <li class="nav-item active">
				<a class="nav-link" href="<?php echo base_url();?>Hospital/hospitaldoctordata">Doctor<span class="sr-only">(current)</span></a>
			  </li>
			  <!-- <li class="nav-item dropdown">
			   ...
			   <li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Transfer</a>
					<ul class="dropdown-menu" aria-labelledby="dropdown05">
						<li><a class="dropdown-item" href="<?php echo base_url();?>Hospital/doctorusersearch">Search patient</a></li>
						
						<li><a class="dropdown-item" href="<?php echo base_url();?>Hospital/transferdataview">Transferred data</a></li>

						<li><a class="dropdown-item" href="<?php echo base_url();?>Hospital/requestpatientdata">Request patient data</a></li>
						<li><a class="dropdown-item" href="<?php echo base_url();?>Hospital/requestdataview">Request</a></li>
						<li><a class="dropdown-item" href="<?php echo base_url();?>Hospital/myrequest">My request</a></li>
					</ul>
			  </li>
			   <!-- <li class="nav-item"><a class="nav-link" href="contact.html">Contact</a></li> -->
			   <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>Hospital/doctornotificationview">Notification</a></li>
			   <li class="nav-item active">
				<a class="nav-link" href="<?php echo base_url();?>Hospital/requstedleave">Leave<span class="sr-only">(current)</span></a>
			  </li> 
			  <li class="nav-item active">
			 
				<a class="nav-link" href="<?php echo base_url();?>Hospital/hchat">Message<span class="sr-only">(current)</span></a>
			  </li>
			   <li class="nav-item active">
			 
				<a class="nav-link" href="<?php echo base_url();?>Hospital/hospitalprofileview">Profile<span class="sr-only">(current)</span></a>
			  </li>
			  <!-- <li class="nav-item active">
				<a class="nav-link" href="<?php echo base_url();?>Hospital/doctorusersearch">Search<span class="sr-only">(current)</span></a>
			  </li> -->
			</ul>
		...
		<div class="row">
			<div class="col-lg-9 col-md-10">
				<div class="block">
					...
					<a href="<?php echo base_url();?>Hospital/hospitalhome" target="_blank" class="btn btn-main animated fadeInUp btn-round-full" >Get started<i class="btn-icon fa fa-angle-right ml-2"></i></a>
				</div>
			</div>
		</div>
	</div>
