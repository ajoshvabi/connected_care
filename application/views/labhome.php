...
<header class="navigation">
	...
	<nav class="navbar navbar-expand-lg  py-4" id="navbar">
		<div class="container">
		<a class="navbar-brand" href="<?php echo base_url();?>Lab/labhome">
		  ...
		  <div class="collapse navbar-collapse text-center" id="navbarsExample09">
			<ul class="navbar-nav ml-auto">
			  <li class="nav-item active">
				<a class="nav-link" href="<?php echo base_url();?>Lab/labhome">Home <span class="sr-only">(current)</span></a>
			  </li>
			  ...
			  <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>Lab/testview">Test</a></li>
