		  ...
		  <div class="collapse navbar-collapse text-center" id="navbarsExample09">
			<ul class="navbar-nav ml-auto">
			  <li class="nav-item active">
				<a class="nav-link" href="<?php echo base_url();?>Admin/home">Home <span class="sr-only">(current)</span></a>
			  </li>
			  <li class="nav-item active">
				<a class="nav-link" href="mailto:connectedcareabgs@gmail.com">Contact  <span class="sr-only">(current)</span></a>
			  <!-- </li><a > <i class="ti-email mr-3"></i>connectedcareabgs@gmail.com</h5></a> -->
			  <!-- <li class="nav-item dropdown">
			   ...
			   <li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Registrations</a>
					<ul class="dropdown-menu" aria-labelledby="dropdown05">
						<li><a class="dropdown-item" href="<?php echo base_url();?>User/userreg">User registration</a></li>
						<li><a class="dropdown-item" href="<?php echo base_url();?>Doctor/doctorreg">Doctor registration</a></li>

						<li><a class="dropdown-item" href="<?php echo base_url();?>Hospital/hospitalreg">Hospital registration</a></li>
					</ul>
			  </li>
			   <!-- <li class="nav-item"><a class="nav-link" href="contact.html">Contact</a></li> -->
               <!-- <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>Lab/profileview">Profile</a></li> -->
			</ul>

			<form class="form-lg-inline my-2 my-md-0 ml-lg-4 text-center">
			  <a href="<?php echo base_url();?>Admin/loginview" class="btn btn-solid-border btn-round-full">Login</a>
			</form>
		  </div>
		</div>
	</nav>
		...
		<div class="row">
			<div class="col-lg-9 col-md-10">
				<div class="block">
					...
					<a href="<?php echo base_url();?>Admin/home" target="_blank" class="btn btn-main animated fadeInUp btn-round-full" >Get started<i class="btn-icon fa fa-angle-right ml-2"></i></a>
				</div>
			</div>
		</div>
	</div>
