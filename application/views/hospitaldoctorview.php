                        ...
                        <table border="1" cellspacing="0" width="100%">
                         ...
                         { ?>
                                ...
                                <th><?php echo $v->name; ?>	</th>
                                    ...
                                    <th><?php echo $v->pincode; ?></th>
                                    <th><?php echo $v->district; ?></th>
                                    <th><?php echo $v->city; ?></th>
                                    <th><?php echo $v->gender; ?></th>
                                    <th><?php echo $v->dob; ?></th>
                                    <th><?php echo $v->specialization; ?></th>
                                    <th><?php echo $v->contactno; ?></th>
                                    <th><?php echo $v->photo; ?></th>
                                </tr>
                                <?php
                         }
                            ?>
        	...
        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
        		...
        		<div class="staff">
      				...
      				<div class="info text-center">
                        ...
                        <table align="center">
                        <tr align="left"> <th>Email:</th><td><a href="" diable><?php echo $v->email; ?></a></td></tr>
