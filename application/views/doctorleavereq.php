             ...
             <div class="notification-list notification-list--unread">
                <div class="notification-list_content">
                    ...
                    <div class="notification-list_detail">
                        ...
                        <p class="text-muted">To <?php echo $v->hospitalname?></p>
                        <p class="text-muted"><?php echo $v->description?></p>
                        <p class="text-muted"><small> <?php echo $v->noday?> days from <?php echo $v->myleave?></small></p>
                    </div>
                </div>
                <div class="notification-list_feature-img">
                    <br>
                        ...
                        ?>
                        Waiting 
                        <a href="<?php echo base_url();?>Doctor/deleteleavereq/<?php echo $v->lid?>" class='btn btn-primary'>Delete</a>
