...
<head>
    ...
    <link href="<?php echo base_url();?>Admin/assets/vendors/themify-icons/css/themify-icons.css" rel="stylesheet" />
    <!-- PLUGINS STYLES-->
    <link href="<?php echo base_url();?>Admin/assets/vendors/jvectormap/jquery-jvectormap-2.0.3.css" rel="stylesheet" />
    <!-- THEME STYLES-->
    <link href="<?php echo base_url();?>Admin/assets/css/main.min.css" rel="stylesheet" />
    <!-- PAGE LEVEL STYLES-->
</head>
...
<body class="fixed-navbar">
    <div class="page-wrapper">
        ...
        <header class="header">
            <div class="page-brand">
                 <a class="link" href="<?php echo base_url(); ?>Admin/adminview">
                    <span class="brand">Connected    
                        <span class="brand-tip">CARE</span>
                    </span>
            ...
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        ...
                        <li>
                                <a href="<?php echo base_url();?>Admin/admincomplaintview">Complaints view</a>
                            </li>
                            <!-- <li>
                    ...
                    <!-- <li>
                        ...
                        <ul class="nav-2-level collapse">
                        <li>
                                <a href="<?php echo base_url();?>Admin/adminnotification">notification</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>Admin/adminnotificationview">notification</a>
                            </li>
                    ...
                    <li>
                        <a href="javascript:;"><i class="sidebar-item-icon fa fa-table"></i>
                            <span class="nav-label">User Request</span><i class="fa fa-angle-left arrow"></i></a>
                        <ul class="nav-2-level collapse">
                            <!-- <li>
                                <a href="table_basic.html">Basic Tables</a>
                            </li> -->
                            <li>
                                <a href="<?php echo base_url();?>Admin/admindoctordataview">Doctor</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>Admin/adminpublicdataview">Public</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>Admin/adminhospitaldataview">Hospital</a>
                            </li>
                            <!-- <li>
                                <a href="<?php echo base_url();?>Admin/adminnotification">notification add</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>Admin/adminnotificationview">notification view</a>
                            </li> -->
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav-2-level collapse">
                            <!-- <li>
                                <a href="table_basic.html">Notifications</a>
                            </li> -->
                            <!-- <li>
                                <a href="<?php echo base_url();?>Admin/admindoctordataview">Doctor</a>
                            </li>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-success color-white widget-stat">
                            <div class="ibox-body">
                                <h2 class="m-b-5 font-strong"><?php echo $nouser;?></h2>
                                <div class="m-b-5">PATIENTS</div><i class="ti-user widget-stat-icon"></i>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-info color-white widget-stat">
                            <div class="ibox-body">
                                <h2 class="m-b-5 font-strong"><?php echo $nodoctor;?></h2>
                                <div class="m-b-5">DOCTOR</div><i class="ti-bar-chart widget-stat-icon"></i>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-warning color-white widget-stat">
                            <div class="ibox-body">
                                <h2 class="m-b-5 font-strong"><?php echo $nohospital;?></h2>
                                <div class="m-b-5">HOSPITAL</div><i class="fa fa-money widget-stat-icon"></i>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-danger color-white widget-stat">
                            <div class="ibox-body">
                                <h2 class="m-b-5 font-strong"><?php echo $nolab;?></h2>
                                <div class="m-b-5">LAB</div><i class="ti-user widget-stat-icon"></i>
                            ...
                            <div class="ibox-body">
                                <div class="flexbox mb-4">
                                    ...
                                    <div class="d-inline-flex">
                                        ...
                                        <div class="px-3">
                                            <!-- <div class="text-muted">WEEKLY SALES</div> u urr -->
                                            <div>
    ...
    <!-- END PAGA BACKDROPS-->
    <!-- CORE PLUGINS-->
    <script src="<?php echo base_url();?>Admin/assets/vendors/jquery/dist/jquery.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url();?>Admin/assets/vendors/popper.js/dist/umd/popper.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url();?>Admin/assets/vendors/bootstrap/dist/js/bootstrap.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url();?>Admin/assets/vendors/metisMenu/dist/metisMenu.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url();?>Admin/assets/vendors/jquery-slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
    <!-- PAGE LEVEL PLUGINS-->
    <script src="<?php echo base_url();?>Admin/assets/vendors/chart.js/dist/Chart.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url();?>Admin/assets/vendors/jvectormap/jquery-jvectormap-2.0.3.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url();?>Admin/assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js" type="text/javascript"></script>
    <script src="<?php echo base_url();?>Admin/assets/vendors/jvectormap/jquery-jvectormap-us-aea-en.js" type="text/javascript"></script>
    <!-- CORE SCRIPTS-->
    <script src="<?php echo base_url();?>Admin/assets/js/app.min.js" type="text/javascript"></script>
    <!-- PAGE LEVEL SCRIPTS-->
    <script src="<?php echo base_url();?>Admin/assets/js/scripts/dashboard_1_demo.js" type="text/javascript"></script>
</body>
